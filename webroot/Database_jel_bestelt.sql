...
-- Dumping structure for table jel_bestelt.berichten
...
-- Dumping data for table jel_bestelt.berichten: ~2 rows (approximately)
...
-- Dumping data for table jel_bestelt.bestellingen: ~2 rows (approximately)
...
-- Dumping data for table jel_bestelt.bestelregels: ~3 rows (approximately)
...
-- Dumping data for table jel_bestelt.reactie: ~2 rows (approximately)
DELETE FROM `reactie`;
