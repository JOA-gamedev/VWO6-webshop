...
<div class="sm:mx-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <a href="productbeheer" class="group block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-indigo-600 hover:text-white transition duration-300">
        ...
        <a href="bestellingen" class="group block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-indigo-600 hover:text-white transition duration-300">
            <div class="flex items-center justify-center mb-4 w-12 h-12 bg-indigo-100 rounded-full group-hover:bg-white">
