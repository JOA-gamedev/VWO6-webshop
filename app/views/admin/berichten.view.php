...
<div class="container mx-auto mt-8 sm:mx-10">
    ...
    <ul class="space-y-4">
        ...
        <li class="p-4 bg-white shadow rounded-md">
            <strong class="block text-lg">Gebruiker ID:</strong>
            <?= htmlspecialchars($message['klant_id'] ?? 'Anonieme gebruiker') ?><br>
            <strong class="block text-lg">Naam:</strong>
            <?= htmlspecialchars($message['klant_naam'] ?? 'Onbekend') ?><br>
            ...
            <form action="/admin/berichten-reply" method="post" class="mt-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="reply" name="reply" placeholder="Typ je reactie hier"
                        class="border border-gray-300 rounded-md p-2 w-full" required></textarea>
                </div>
                <div class="text-center">
                    <input type="submit" value="Verstuur"
                        class="bg-[#52EBEB] text-white rounded-md px-4 py-2 hover:bg-[#3ACBCB] cursor-pointer">
                </div>
            </form>
        </li>
        <?php endforeach; ?>
