...
?>
    <div class="sm:mx-10">
        ...
        <p class="my-4">Welkom bij De Kleding van Joachim, Jens en Fiona – dé plek waar stijl en technologie samenkomen! 
            ...
            Heb je vragen of feedback? Laat het ons weten, we horen graag van je!
        </p>
