...
<div class="sm:mx-10">
    <div class="bg-cover bg-center h-64 text-black flex items-center justify-center" style="background-image: url('/images/eye-catcher.png');">
        <h1 class="text-4xl font-bold bg-white bg-opacity-75 p-4 rounded">Welkom bij onze Kledingwinkel</h1>
    </div>
